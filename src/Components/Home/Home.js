        ...
        <div>
            <section className="banner bg-fixed" style={sectionStyle}>
                <div className='text-white'>
                    <h1 className='text-xl md:text-5xl md:px-10 md:pt-[120px] font-semibold'><span className='text-blue-500 text-6xl'>S</span>P's</h1>
                    <h1 className='text-xl md:text-5xl md:px-10 md:pt-[20px] font-semibold'><span className='text-blue-500 text-6xl'>C</span>reative <span className='text-blue-500 text-6xl'>P</span>hotography</h1>
