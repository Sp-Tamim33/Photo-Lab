        ...
        <div>
            ...
            <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="https://flowbite.com" className="flex items-center">
                            <span className="self-center font-serif font-semibold whitespace-nowrap text-4xl"> <span className='text-blue-600'>S</span><span className='text-white'>p-</span><span className='text-blue-600'>P</span  ><span className='text-white'>hotoLab</span>
                            </span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <a href="home" className="hover:underline">PhotoLab</a>
                                </li>
                                <li>
                                    <a href="home" className="hover:underline">See Images</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <a href="home" className="hover:underline ">Github</a>
                                </li>
                                <li>
                                    <a href="home" className="hover:underline">Discord</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" className="hover:underline"> Sp-PhotoLab ™</a>. All Rights Reserved.
                    </span>
